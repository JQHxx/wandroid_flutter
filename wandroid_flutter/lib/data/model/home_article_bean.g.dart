...
part of 'home_article_bean.dart';
...
HomeArticleData _$HomeArticleDataFromJson(Map<String, dynamic> json) {
  return HomeArticleData(
    ...
    (json['datas'] as List)
        ?.map((e) => e == null
            ? null
            : HomeArticleDatas.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    json['offset'] as int,
    json['over'] as bool,
...
HomeArticleDatas _$HomeArticleDatasFromJson(Map<String, dynamic> json) {
  return HomeArticleDatas(
    ...
    (json['tags'] as List)
        ?.map((e) => e == null
            ? null
            : HomeArticleTags.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$HomeArticleDatasToJson(HomeArticleDatas instance) =>
    <String, dynamic>{
...
HomeArticleTags _$HomeArticleTagsFromJson(Map<String, dynamic> json) {
  return HomeArticleTags(
    json['name'] as String,
    json['url'] as String,
  );
}

Map<String, dynamic> _$HomeArticleTagsToJson(HomeArticleTags instance) =>
    <String, dynamic>{
      'name': instance.name,
      'url': instance.url,
    };
